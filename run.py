        ...
        for i in range(0, len(config['readorders'])):
            ...
            if not 'nextwakeup' in readOrder:
                ...
                if interval > 60:
                    ...
                    readOrder['nextwakeup'] = ((readOrder['nextwakeup'] // 60) // (interval // 60)) * (
                                interval // 60) * 60
                ...
                if timeInAbsoluteSeconds >= readOrder['nextwakeup']:
                    ...
                    if ('value' in readOrder) & ('threshold' in readOrder) & ('oldvalue' in readOrder):
                        if (((readOrder['value'] - readOrder['threshold']) >= readOrder['oldvalue']) | (
                                (readOrder['value'] + readOrder['threshold']) <= readOrder['oldvalue']) | (
